...
# Choose Languages
langlist = {"0": "en_US", "1": "zh_CN"}
print(langlist)

try:
    lang = langlist[
        input(multicol.Green("Please choose a language to continue the wizard: "))
    ]
except KeyError:
    lang = "en_US"
...
es = gettext.translation(
    "setup", localedir="../locale", languages=[lang], fallback=True
)
es.install()
...
print(
    _(
        "   If you select this, we'll copy a new template config \
...
print(
    _(
        "   If select this, we'll check updates and upgrade it.\
 It needs\n   Internet."
    )
)
print("\n")
